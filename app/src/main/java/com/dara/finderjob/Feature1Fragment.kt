...
import com.dara.finderjob.databinding.FragmentFeature1Binding
...
class Feature1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentFeature1Binding = FragmentFeature1Binding.inflate(inflater, container, false)
        binding.apply {
            btnNext.setOnClickListener {
                it.findNavController().navigate(R.id.action_feature1Fragment_to_feature2Fragment)
            }
        }
        return binding.root
    }
